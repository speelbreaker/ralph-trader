...
|---|---|---|---|---|
| RALPH-CMP-012 | 2026-02-14 | Expanded crash-mid-intent test coverage from 1 to 7 tests with restart variants (Sent state, terminal states, mixed states, ghost detection, WAL failures, fsync barriers). | All 7 tests pass; coverage matches opus pattern. | `/Users/admin/Desktop/ralph/crates/soldier_infra/tests/test_crash_mid_intent.rs`; commit 6d9d47c7 |
| RALPH-CMP-011 | 2026-02-14 | Added S6-007 (Inventory Skew Gate), S6-008 (PendingExposure Reservation), S6-009 (Global Exposure Budget), S6-010 (Margin Headroom Gate) to PRD with full CONTRACT.md traceability. | All 4 stories present in PRD with correct ATs, reason codes, enforcement points. | `/Users/admin/Desktop/ralph/plans/prd.json`; stories S6-007 through S6-010 |
| RALPH-CMP-017 | 2026-02-14 | Participated in pinned explicit-ref comparison rerun where quick verify was intentionally scoped to opus only to avoid ralph workflow-acceptance noise. | Report records pinned refs and verify split (`opus=FAIL`, `ralph=not run`) while preserving ralph outcome signals. | `/Users/admin/Desktop/opus-trader/artifacts/phase1_compare/20260214_003150/report.md`; tag `phase1-compare-explicit-20260214-003126-ralph` |
