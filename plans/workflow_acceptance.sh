...
run_in_worktree git update-index --no-skip-worktree plans/ralph.sh plans/verify.sh plans/prd.json plans/prd_schema_check.sh plans/prd_lint.sh plans/prd_ref_check.sh plans/prd_ref_index.sh plans/run_prd_auditor.sh plans/build_markdown_digest.sh plans/build_contract_digest.sh plans/build_plan_digest.sh plans/prd_slice_prepare.sh plans/contract_review_validate.sh plans/workflow_contract_gate.sh plans/workflow_contract_map.json specs/WORKFLOW_CONTRACT.md >/dev/null 2>&1 || true
...
run_in_worktree git update-index --skip-worktree plans/ralph.sh plans/verify.sh plans/prd.json plans/prd_schema_check.sh plans/prd_lint.sh plans/prd_ref_check.sh plans/prd_ref_index.sh plans/run_prd_auditor.sh plans/build_markdown_digest.sh plans/build_contract_digest.sh plans/build_plan_digest.sh plans/prd_slice_prepare.sh plans/contract_review_validate.sh plans/workflow_contract_gate.sh plans/workflow_contract_map.json specs/WORKFLOW_CONTRACT.md >/dev/null 2>&1 || true
