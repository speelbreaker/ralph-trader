...
## 0) What shipped
- Feature/behavior: audit parallel caching + merge tooling; workflow acceptance updates; Deribit vendor doc; knowledge index; invariants appendix; review checklist skill-use prompt.
