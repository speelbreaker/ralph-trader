...
## 0) What shipped
- Feature/behavior: Stabilized workflow acceptance test 10c (update_task blocks non-promotion verify) by forcing a deterministic diff before committing the non-promo PRD file.
...
- Workaround I used this PR (exploit): force a newline diff on the PRD file before committing in test 10c (update_task blocks non-promotion verify).
...
- Smallest increment: append a newline before committing the PRD file in test 10c (update_task blocks non-promotion verify).
